...
class FakeInterceptor(private val mContext: Context) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        val listSuggestionFileName: MutableList<String> =
            ArrayList()
        ...
        Log.d(
            TAG,
            "--> Request url: [" + method.toUpperCase() + "]" + uri.toString()
        )
        ...
        if (responseFileName != null) {
            ...
            for (file in listSuggestionFileName) {
                Log.e(
                    TAG,
                    "File not exist: " + getFilePath(uri, file)
                )
            }
        ...
        Log.d(
            TAG,
            "<-- END [" + method.toUpperCase() + "]" + uri.toString()
        )
        return response!!
    }
